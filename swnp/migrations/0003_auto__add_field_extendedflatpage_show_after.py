...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExtendedFlatPage.show_after'
        db.add_column('swnp_extendedflatpage', 'show_after',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='flatpage_predecessor', null=True, blank=True, to=orm['swnp.ExtendedFlatPage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExtendedFlatPage.show_after'
        db.delete_column('swnp_extendedflatpage', 'show_after_id')
