...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'computer', 'ip', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Computer.responsive'
        db.delete_column(u'computer', 'responsive')


        # Changing field 'Computer.ip'
        db.alter_column(u'computer', 'ip', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'swnp.computer': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'responsive': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
